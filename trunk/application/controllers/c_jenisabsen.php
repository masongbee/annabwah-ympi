<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
		...
		class C_jenisabsen extends CI_Controller {

			function __construct(){
				parent::__construct();		
				$this->load->model('m_jenisabsen', '', TRUE);
			}
			...
			function getAll(){
				 ...
				 * Processing Data
				 */
				$result = $this->m_jenisabsen->getAll($start, $page, $limit);
			...
			function save(){
				 ...
				 * Processing Data
				 */
				$result = $this->m_jenisabsen->save($data);
				echo json_encode($result);
			}
			...
			function delete(){
				 ...
				 * Processing Data
				 */
				$result = $this->m_jenisabsen->delete($data);
				echo json_encode($result);
			}
			...
			function export2Excel(){
				...
				$filename='jenisabsen.xlsx'; //save our workbook as this file name
			...
			function export2PDF(){
				...
				$this->html2pdf->filename('jenisabsen.pdf');
				
				//Set the paper defaults
				$this->html2pdf->paper('a4', 'portrait');
				
				//Load html view
				$this->html2pdf->html($this->load->view('pdf_jenisabsen', $data, true));
			...
			function printRecords(){
				...
				$data["records"] = $getdata;
				$data["table"] = "jenisabsen";
				$print_view=$this->load->view("p_jenisabsen.php",$data,TRUE);
				if(!file_exists("temp")){
					mkdir("temp");
				}
				$print_file=fopen("temp/jenisabsen.html","w+");
