...
(IF(TIME(p.TJKELUAR)>t1.JAMREHAT3S AND TIME(p.TJMASUK)<=t1.JAMREHAT3M,TIMESTAMPDIFF(MINUTE,TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT3M),TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT3S)),0))) as POTONGISTIRAHAT
		...
		SET
			hp.TERLAMBAT=IF(hp.JENISABSEN='LB' AND hp.JAMLEMBUR > 0,NULL,NULL),
			hp.PLGLBHAWAL=IF(hp.JENISABSEN='LB' AND hp.JAMLEMBUR > 0,NULL,NULL),
			hp.JAMKURANG=IF(hp.JENISABSEN='LB' AND hp.JAMLEMBUR > 0,NULL,NULL),
			hp.JENISABSEN=IF((IF(ABS((LB.JAMBERSIH)/60) > 0,1,0)) = 1,IF(LB.POLA = '0',IF(LB.JAMLEMBUR > 0, 'LB','OF'),'HD'),'AL'),
			hp.JAMKERJA=IF(LB.JENISLEMBUR != 'B', 0, ((LB.JAMBERSIH-LB.JL) /60)),
		...
		JOIN (
			SELECT T1.TANGGAL,T1.NIK,T1.JENISABSEN,T1.AMBILCUTI,T1.STATUSIJIN, T1.JAMDARI,t1.JAMSAMPAI,
		...
		SET	
			T2.JAMKERJA=IF(T3.JENISABSEN = 'IP',((T2.JAMKERJA*60)-T3.TOTALIJIN)/60,T2.JAMKERJA),
			T2.JENISABSEN=IF(T3.JENISABSEN = 'IP','HD',T3.JENISABSEN),
			t2.JAMKURANG=IF(T3.JENISABSEN = 'IZ',T2.JAMKURANG+T3.TOTALIJIN,IF(T3.AMBILCUTI='0',480,0)),
			t2.IZINPRIBADI=IF(T3.JENISABSEN = 'IP',T3.TOTALIJIN,'0')
			";
		...
		SET
			...
			T4.JAMKURANG=IF(T3.SISACUTI='0' AND T3.STATUSCUTI='T',T3.LAMA*480,0)";
