...
class M_hitungpresensi extends CI_Model{
	...
	function ProcessUpdate($tglmulai,$tglsampai){
		...
		*/
		...
		SET
			hp.JAMKERJA=((LB.JAMBERSIH-LB.JL) /60),
			hp.JAMLEMBUR=(IF(MOD(LB.JAMLEMBUR,60)<= 44 AND MOD(LB.JAMLEMBUR,60)>= 15,(LB.JAMLEMBUR - MOD(LB.JAMLEMBUR,60))+30,IF(MOD(LB.JAMLEMBUR,60) >= 45,(LB.JAMLEMBUR - MOD(LB.JAMLEMBUR,60))+60,0))/60),
