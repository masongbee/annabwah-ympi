Ext.define('YMPI.view.dataMaster.UnitKerja', {
	extend: 'Ext.grid.Panel',
    requires: ['YMPI.store.UnitKerja'],
    
    title		: 'Unit Kerja',
    itemId		: 'unitKerjaGrid',
    alias       : 'widget.unitKerjaGrid',
	store 		: 'UnitKerja',
    columnLines : true,
    //region		: 'center',
    ...
    initComponent: function(){
    	...
    	this.rowEditing = Ext.create('Ext.grid.plugin.RowEditing', {
			  ...
			  listeners: {
				  ...
				  'afteredit': function(editor, e){
					  if(eval(e.record.data.KODEUNIT) < 1){
        ...
        this.columns = [
            { header: 'Kode', dataIndex: 'KODEUNIT', editor: {xtype: 'textfield'} },
