...
Ext.application({
    ...
    controllers: [
        'Main', 'UNITKERJA','PERIODEGAJI', 'USERMANAGE', 'KARYAWAN', 'IMPORTPRES', 'HITPRES', 'POSTPRES', 'JENISABSEN','KALENDERLIBUR','PRESENSILEMBUR','SHIFTJAMKERJA','SHIFT','DETILSHIFT','JEMPUTANKAR',
		...
		'MONKAR', 'LAPNAMETAG', 'NAMETAG', 'RINCIANCUTI'
    ],
