Ext.define('YMPI.view.MASTER.v_tkeluarga', {
	extend: 'Ext.grid.Panel',
	requires: ['YMPI.store.s_tkeluarga'],
	
	title		: 'tkeluarga',
	itemId		: 'Listtkeluarga',
	alias       : 'widget.Listtkeluarga',
	store 		: 's_tkeluarga',
	columnLines : true,
	frame		: true,
	...
	initComponent: function(){
		...
		var UMURTO_field = Ext.create('Ext.form.field.Number', {
			disabled: true
		});
		...
		this.columns = [
			{
				...
				field: {
					...
					listeners: {
						keyup: function(me, e){
							if (me.value.charAt(0) == 'A') {
								UMURTO_field.setDisabled(false);
							}
						}
					}
				}
