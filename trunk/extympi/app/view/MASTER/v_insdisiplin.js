Ext.define('YMPI.view.MASTER.v_insdisiplin', {
	extend: 'Ext.grid.Panel',
	requires: ['YMPI.store.s_insdisiplin'],
	
	title		: 'insdisiplin',
	itemId		: 'Listinsdisiplin',
	alias       : 'widget.Listinsdisiplin',
	store 		: 's_insdisiplin',
	columnLines : true,
	frame		: true,
			...
			items: [{
				...
				items: [{
					...
					handler: function(){
						...
						if(form.isValid()){
							form.submit({
								url: 'c_insdisiplin/validtoall_update',
								waitMsg: 'Updating...',
