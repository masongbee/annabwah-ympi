Ext.define('YMPI.view.TRANSAKSI.kompensasicuti', {
	extend: 'Ext.grid.Panel',
    requires: ['YMPI.store.kompensasicuti'],
    
    title		: 'Kompensasi Cuti',
    itemId		: 'kompensasicuti',
    alias       : 'widget.kompensasicuti',
	store 		: 'kompensasicuti',
    columnLines : true,
    region		: 'center',    
	//height		: 495,
    frame		: true,
    ...
    initComponent: function(){
    	...
    	var karStore = Ext.create('YMPI.store.kompensasicuti');
    	...
    	this.rowEditing = Ext.create('Ext.grid.plugin.RowEditing', {
			  ...
			  listeners: {
				  ...
				  'afteredit': function(editor, e){
					  if((e.record.data.NIK == '') || (e.record.data.NIK == 0)){
						  Ext.Msg.alert('Peringatan', 'Kolom \"kompensasicuti Name\" tidak boleh kosong.');
						  return false;
					  }
					  e.store.sync();
        ...
        this.columns = [
            ...
            { header: 'TAHUN', dataIndex: 'TAHUN' },
            { header: 'TANGGAL', dataIndex: 'TANGGAL' },
            { header: 'SISA CUTI', dataIndex: 'SISACUTI' },
            { header: 'RP KOMPEN', dataIndex: 'RPKOMPEN' },
            { header: 'BULAN', dataIndex: 'BULAN' },
            { header: 'POSTING', dataIndex: 'POSTING' }
        ];
