Ext.define('YMPI.view.TRANSAKSI.v_tambahanlain2', {
	extend: 'Ext.grid.Panel',
	requires: ['YMPI.store.s_tambahanlain2'],
	
	title		: 'tambahanlain2',
	itemId		: 'Listtambahanlain2',
	alias       : 'widget.Listtambahanlain2',
	store 		: 's_tambahanlain2',
	columnLines : true,
	frame		: true,
	...
	initComponent: function(){
		...
		/* STORE start */
		var kodeupah_store = Ext.create('YMPI.store.s_jenistambahan', {
			autoLoad: true
		});
		...
		var KODEUPAH_field = Ext.create('Ext.form.ComboBox', {
	        ...
	        tpl: Ext.create('Ext.XTemplate',
                '<tpl for=".">',
                    '<div class="x-boundlist-item">[<b>{KODEUPAH}</b>] - {NAMAUPAH}</div>',
                '</tpl>'
            ),
