            ...
            <table cellpadding="15px">
              ...
              <tr>
                <td>
					...
					<a href="#" onclick="document.forms[6].submit();return false;"><img id="mnjshift" src="<?php echo base_url(); ?>assets/images/logoapp/mnjshift.png" width="120" height="120" alt="mnjshift"></a>
					</form>
                </td>
                <td>
					<form action="<?php echo base_url() ?>login" method="post">
					<input type="hidden" name="group" value="mnjtugas">
					<a href="#" onclick="document.forms[7].submit();return false;"><img id="mnjtugas" src="<?php echo base_url(); ?>assets/images/logoapp/mnjtugas.png" width="120" height="120" alt="mnjtugas"></a>
					</form>
                </td>
                <td>
					<form action="<?php echo base_url() ?>login" method="post">
					<input type="hidden" name="group" value="mnjuser">
					<a href="#" onclick="document.forms[8].submit();return false;"><img id="mnjuser" src="<?php echo base_url(); ?>assets/images/logoapp/mnjuser.png" width="120" height="120" alt="mnjuser"></a>
					</form>
                </td>
                <td>
					<form action="<?php echo base_url() ?>login" method="post">
					<input type="hidden" name="group" value="nilaikinerja">
					<a href="#" onclick="document.forms[9].submit();return false;"><img id="nilaikinerja" src="<?php echo base_url(); ?>assets/images/logoapp/nilaikinerja.png" width="120" height="120" alt="nilaikinerja"></a>
					</form>
                </td>
                <td>
					<form action="<?php echo base_url() ?>login" method="post">
					<input type="hidden" name="group" value="spkk">
					<a href="#" onclick="document.forms[10].submit();return false;"><img id="spkk" src="<?php echo base_url(); ?>assets/images/logoapp/spkk.png" width="120" height="120" alt="spkk"></a>
					</form>
                </td>
                <td>
					<form action="<?php echo base_url() ?>login" method="post">
					<input type="hidden" name="group" value="trainingdev">
					<a href="#" onclick="document.forms[11].submit();return false;"><img id="trainingdev" src="<?php echo base_url(); ?>assets/images/logoapp/trainingdev.png" width="120" height="120" alt="trainingdev"></a>
					</form>
                </td>
              </tr>
            </table>        
