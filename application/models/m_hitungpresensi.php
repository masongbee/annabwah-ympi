	...
	function ProcessUpdate($tglmulai,$tglsampai){
		...
		*/
		...
		JOIN (
			...
			IF(t1.JENISHARI ='N',
				(IF(TIME(p.TJKELUAR)>t1.JAMREHAT1S,TIMESTAMPDIFF(MINUTE,TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT1M),TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT1S)),0))	+(IF(TIME(p.TJKELUAR)>t1.JAMREHAT2S,TIMESTAMPDIFF(MINUTE,TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT2M),TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT2S)),0))				+(IF(TIME(p.TJKELUAR)>t1.JAMREHAT3S,TIMESTAMPDIFF(MINUTE,TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT3M),TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT3S)),0)),				(IF(TIME(p.TJKELUAR)>t1.JAMREHAT1S,TIMESTAMPDIFF(MINUTE,TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT1M),TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT1S)),0))				+(IF(TIME(p.TJKELUAR)>t1.JAMREHAT2S,TIMESTAMPDIFF(MINUTE,TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT2M),TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT2S)),0))
				+(IF(TIME(p.TJKELUAR)>t1.JAMREHAT3S,TIMESTAMPDIFF(MINUTE,TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT3M),TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT3S)),0))
				)) AS JAMBERSIH,
			IF(t1.JENISHARI ='N',
				(IF(TIME(p.TJKELUAR)>t1.JAMREHAT1S,TIMESTAMPDIFF(MINUTE,TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT1M),TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT1S)),0))				+(IF(TIME(p.TJKELUAR)>t1.JAMREHAT2S,TIMESTAMPDIFF(MINUTE,TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT2M),TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT2S)),0))				+(IF(TIME(p.TJKELUAR)>t1.JAMREHAT3S,TIMESTAMPDIFF(MINUTE,TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT3M),TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT3S)),0)),				(IF(TIME(p.TJKELUAR)>t1.JAMREHAT1S,TIMESTAMPDIFF(MINUTE,TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT1M),TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT1S)),0))				+(IF(TIME(p.TJKELUAR)>t1.JAMREHAT2S,TIMESTAMPDIFF(MINUTE,TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT2M),TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT2S)),0))
				+(IF(TIME(p.TJKELUAR)>t1.JAMREHAT3S,TIMESTAMPDIFF(MINUTE,TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT3M),TIMESTAMP(DATE(p.TJMASUK),t1.JAMREHAT3S)),0))
			...
			SELECT h.TANGGAL,h.BULAN,h.NIK,h.JENISLEMBUR,h.JAMLEMBUR,
				...
				IF (h.JAMLEMBUR <= l.BATAS1, h.JAMLEMBUR*l.PENGALI1,
					IF (l.BATAS2 <= 0,(l.BATAS1*l.PENGALI1)+(h.JAMLEMBUR-l.BATAS1)*l.PENGALI2,
						(l.BATAS1*l.PENGALI1)+(h.JAMLEMBUR-l.BATAS1)*l.PENGALI2+(h.JAMLEMBUR-l.BATAS1-l.BATAS2)*l.PENGALI3)
				) AS SATLEMBUR
