...
Ext.application({
    ...
    controllers: [
        'Main', 'UNITKERJA', 'USERMANAGE', 'KARYAWAN', 'IMPORTPRES', 'HITPRES', 'POSTPRES', 'JENISABSEN','KALENDERLIBUR','PRESENSILEMBUR','SHIFTJAMKERJA',
        'MOHONIZIN', 'MOHONCUTI', 'RINCIANCUTI', 'KOMPENCUTI', 'SPLEMBUR', 'GRADE','CUTITAHUNAN', 'UPAHPOKOK', 'S_INFO', 'EDITPRES', 'RENCANALEMBUR',
		...
		'POTONGAN', 'CICILAN', 'UANGSIMPATI', 'BONUS', 'TKEHADIRAN', 'THR', 'PERIODEGAJI', 'TRMAKAN'
    ],
